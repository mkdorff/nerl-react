...
If you don't have yarn, install yarn

```
brew install yarn
```

Great. Now install the modules

```
yarn install
```

You're done! Start the server with 

```
yarn start
```

If you don't have brew or node, that's a whole other process. Talk to someone or Google it.
